...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = f'dl1{CMD_INDEX}'
        self.UnzipMirrorCommand = f'unzip1{CMD_INDEX}'
        self.ZipMirrorCommand = f'zip1{CMD_INDEX}'
        self.CancelMirror = f'batal1{CMD_INDEX}'
        self.CancelAllCommand = f'batalin1{CMD_INDEX}'
        self.ListCommand = f'list1{CMD_INDEX}'
        self.SearchCommand = f'cari1{CMD_INDEX}'
        self.StatusCommand = f'status1{CMD_INDEX}'
        self.AuthorizedUsersCommand = f'users1{CMD_INDEX}'
        self.AuthorizeCommand = f'auth1{CMD_INDEX}'
        self.UnAuthorizeCommand = f'unauth1{CMD_INDEX}'
        ...
        self.HelpCommand = f'bantuan1{CMD_INDEX}'
        self.LogCommand = f'log1{CMD_INDEX}'
        self.CloneCommand = f'salin1{CMD_INDEX}'
        self.CountCommand = f'hitung1{CMD_INDEX}'
        self.WatchCommand = f'watch1{CMD_INDEX}'
        self.ZipWatchCommand = f'zipwatch1{CMD_INDEX}'
        self.QbMirrorCommand = f'qb1{CMD_INDEX}'
        self.QbUnzipMirrorCommand = f'qbunzip1{CMD_INDEX}'
        self.QbZipMirrorCommand = f'qbzip1{CMD_INDEX}'
        ...
        self.QbSelectCommand = f'qbsel1{CMD_INDEX}'
